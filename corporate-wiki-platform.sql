...
--
-- Name: users_invitation; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.users_invitation OWNER TO postgres;

--
-- Name: users_invitation_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: wiki_article; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.wiki_article (
    id bigint NOT NULL,
...
ALTER TABLE public.wiki_article OWNER TO postgres;

--
-- Name: wiki_article_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.wiki_article ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.wiki_article_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: wiki_article_tags; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.wiki_article_tags (
    id bigint NOT NULL,
...
ALTER TABLE public.wiki_article_tags OWNER TO postgres;

--
-- Name: wiki_article_tags_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.wiki_article_tags ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.wiki_article_tags_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: wiki_bookmark; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.wiki_bookmark OWNER TO postgres;

--
-- Name: wiki_bookmark_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: wiki_category; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.wiki_category (
    ...
    parent_id bigint,
    CONSTRAINT wiki_category_level_check CHECK ((level >= 0)),
    CONSTRAINT wiki_category_lft_check CHECK ((lft >= 0)),
    CONSTRAINT wiki_category_rght_check CHECK ((rght >= 0)),
    CONSTRAINT wiki_category_tree_id_check CHECK ((tree_id >= 0))
);


ALTER TABLE public.wiki_category OWNER TO postgres;

--
-- Name: wiki_category_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.wiki_category ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.wiki_category_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: wiki_tag; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.wiki_tag OWNER TO postgres;

--
-- Name: wiki_tag_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: wiki_viewhistory; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.wiki_viewhistory (
    id bigint NOT NULL,
...
ALTER TABLE public.wiki_viewhistory OWNER TO postgres;

--
-- Name: wiki_viewhistory_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.wiki_viewhistory ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.wiki_viewhistory_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
53	Can add Тег	14	add_tag
54	Can change Тег	14	change_tag
55	Can delete Тег	14	delete_tag
56	Can view Тег	14	view_tag
...
61	Can add Статья	16	add_article
62	Can change Статья	16	change_article
63	Can delete Статья	16	delete_article
64	Can view Статья	16	view_article
...
69	Can add view history	18	add_viewhistory
70	Can change view history	18	change_viewhistory
71	Can delete view history	18	delete_viewhistory
72	Can view view history	18	view_viewhistory
\.
...
1	2025-09-17 05:18:49.677597+00	1	imakarovms@gmail.com	2	[{"changed": {"fields": ["Verified"]}}]	7	1
2	2025-09-17 05:18:52.794708+00	1	imakarovms@gmail.com	2	[{"changed": {"fields": ["Primary"]}}]	7	1
3	2025-09-17 05:51:30.470666+00	1	КБА	1	[{"added": {}}]	15	1
4	2025-09-17 05:51:42.067234+00	1	Первая статья	1	[{"added": {}}]	16	1
...
1	contenttypes	0001_initial	2025-09-17 04:26:54.995621+00
2	contenttypes	0002_remove_content_type_name	2025-09-17 04:26:55.003121+00
3	auth	0001_initial	2025-09-17 04:26:55.052921+00
4	auth	0002_alter_permission_name_max_length	2025-09-17 04:26:55.0571+00
5	auth	0003_alter_user_email_max_length	2025-09-17 04:26:55.061392+00
6	auth	0004_alter_user_username_opts	2025-09-17 04:26:55.065879+00
7	auth	0005_alter_user_last_login_null	2025-09-17 04:26:55.071154+00
8	auth	0006_require_contenttypes_0002	2025-09-17 04:26:55.072962+00
9	auth	0007_alter_validators_add_error_messages	2025-09-17 04:26:55.077563+00
10	auth	0008_alter_user_username_max_length	2025-09-17 04:26:55.082444+00
11	auth	0009_alter_user_last_name_max_length	2025-09-17 04:26:55.086713+00
12	auth	0010_alter_group_name_max_length	2025-09-17 04:26:55.094178+00
13	auth	0011_update_proxy_permissions	2025-09-17 04:26:55.099252+00
14	auth	0012_alter_user_first_name_max_length	2025-09-17 04:26:55.103742+00
15	users	0001_initial	2025-09-17 04:26:55.163281+00
16	account	0001_initial	2025-09-17 04:26:55.211+00
17	account	0002_email_max_length	2025-09-17 04:26:55.221213+00
18	account	0003_alter_emailaddress_create_unique_verified_email	2025-09-17 04:26:55.238367+00
19	account	0004_alter_emailaddress_drop_unique_email	2025-09-17 04:26:55.265828+00
20	account	0005_emailaddress_idx_upper_email	2025-09-17 04:26:55.276141+00
21	admin	0001_initial	2025-09-17 04:26:55.306029+00
22	admin	0002_logentry_remove_auto_add	2025-09-17 04:26:55.312132+00
23	admin	0003_logentry_add_action_flag_choices	2025-09-17 04:26:55.319187+00
24	sessions	0001_initial	2025-09-17 04:26:55.335744+00
25	sites	0001_initial	2025-09-17 04:26:55.34131+00
26	sites	0002_alter_domain_unique	2025-09-17 04:26:55.350786+00
27	socialaccount	0001_initial	2025-09-17 04:26:55.435045+00
28	socialaccount	0002_token_max_lengths	2025-09-17 04:26:55.454807+00
29	socialaccount	0003_extra_data_default_dict	2025-09-17 04:26:55.463067+00
30	socialaccount	0004_app_provider_id_settings	2025-09-17 04:26:55.48463+00
31	socialaccount	0005_socialtoken_nullable_app	2025-09-17 04:26:55.502408+00
32	socialaccount	0006_alter_socialaccount_extra_data	2025-09-17 04:26:55.523899+00
33	users	0002_invitation	2025-09-17 04:26:55.538855+00
34	wiki	0001_initial	2025-09-17 04:26:55.634433+00
...
--
-- Data for Name: users_invitation; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.users_invitation (id, email, token, created_at, is_used) FROM stdin;
\.


--
-- Data for Name: wiki_article; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: wiki_article_tags; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.wiki_article_tags (id, article_id, tag_id) FROM stdin;
\.


--
-- Data for Name: wiki_bookmark; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.wiki_bookmark (id, created_at, article_id, user_id) FROM stdin;
\.


--
-- Data for Name: wiki_category; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: wiki_tag; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.wiki_tag (id, name, slug) FROM stdin;
1	КБА	kba
\.


--
-- Data for Name: wiki_viewhistory; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: users_invitation_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.users_invitation_id_seq', 1, false);
...
--
-- Name: wiki_article_tags_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.wiki_article_tags_id_seq', 1, false);
...
--
-- Name: wiki_tag_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.wiki_tag_id_seq', 1, true);
...
--
-- Name: users_invitation users_invitation_email_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users_invitation
    ADD CONSTRAINT users_invitation_email_key UNIQUE (email);


--
-- Name: users_invitation users_invitation_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: wiki_article wiki_article_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_article
    ADD CONSTRAINT wiki_article_pkey PRIMARY KEY (id);


--
-- Name: wiki_article wiki_article_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: wiki_article_tags wiki_article_tags_article_id_tag_id_00e4a830_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_article_tags
    ADD CONSTRAINT wiki_article_tags_article_id_tag_id_00e4a830_uniq UNIQUE (article_id, tag_id);


--
-- Name: wiki_article_tags wiki_article_tags_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_article_tags
    ADD CONSTRAINT wiki_article_tags_pkey PRIMARY KEY (id);


--
-- Name: wiki_bookmark wiki_bookmark_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: wiki_bookmark wiki_bookmark_user_id_article_id_8763e611_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_bookmark
    ADD CONSTRAINT wiki_bookmark_user_id_article_id_8763e611_uniq UNIQUE (user_id, article_id);


--
-- Name: wiki_category wiki_category_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_category
    ADD CONSTRAINT wiki_category_name_key UNIQUE (name);


--
-- Name: wiki_category wiki_category_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: wiki_category wiki_category_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: wiki_tag wiki_tag_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_tag
    ADD CONSTRAINT wiki_tag_name_key UNIQUE (name);


--
-- Name: wiki_tag wiki_tag_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: wiki_tag wiki_tag_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_tag
    ADD CONSTRAINT wiki_tag_slug_key UNIQUE (slug);


--
-- Name: wiki_viewhistory wiki_viewhistory_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_viewhistory
    ADD CONSTRAINT wiki_viewhistory_pkey PRIMARY KEY (id);
...
--
-- Name: users_invitation_email_92d062ff_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX users_invitation_email_92d062ff_like ON public.users_invitation USING btree (email varchar_pattern_ops);


--
-- Name: wiki_article_author_id_ff87219f; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_article_author_id_ff87219f ON public.wiki_article USING btree (author_id);


--
-- Name: wiki_article_category_id_18cb89c0; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_article_category_id_18cb89c0 ON public.wiki_article USING btree (category_id);


--
-- Name: wiki_article_slug_fc132d29_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_article_slug_fc132d29_like ON public.wiki_article USING btree (slug varchar_pattern_ops);


--
-- Name: wiki_article_tags_article_id_b7b17f39; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_article_tags_article_id_b7b17f39 ON public.wiki_article_tags USING btree (article_id);


--
-- Name: wiki_article_tags_tag_id_faa96f90; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_article_tags_tag_id_faa96f90 ON public.wiki_article_tags USING btree (tag_id);


--
-- Name: wiki_bookmark_article_id_9f9d9e8e; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_bookmark_article_id_9f9d9e8e ON public.wiki_bookmark USING btree (article_id);


--
-- Name: wiki_bookmark_user_id_596bc124; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_bookmark_user_id_596bc124 ON public.wiki_bookmark USING btree (user_id);


--
-- Name: wiki_category_name_5556690d_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_category_name_5556690d_like ON public.wiki_category USING btree (name varchar_pattern_ops);


--
-- Name: wiki_category_parent_id_c3e2dc79; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_category_parent_id_c3e2dc79 ON public.wiki_category USING btree (parent_id);


--
-- Name: wiki_category_slug_71ef5da5_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_category_slug_71ef5da5_like ON public.wiki_category USING btree (slug varchar_pattern_ops);


--
-- Name: wiki_category_tree_id_7234f28f; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_category_tree_id_7234f28f ON public.wiki_category USING btree (tree_id);


--
-- Name: wiki_tag_name_0c8f5bf2_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_tag_name_0c8f5bf2_like ON public.wiki_tag USING btree (name varchar_pattern_ops);


--
-- Name: wiki_tag_slug_726f445c_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_tag_slug_726f445c_like ON public.wiki_tag USING btree (slug varchar_pattern_ops);


--
-- Name: wiki_viewhistory_article_id_52faa055; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_viewhistory_article_id_52faa055 ON public.wiki_viewhistory USING btree (article_id);


--
-- Name: wiki_viewhistory_user_id_959d7a84; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX wiki_viewhistory_user_id_959d7a84 ON public.wiki_viewhistory USING btree (user_id);
...
--
-- Name: wiki_article wiki_article_author_id_ff87219f_fk_users_customuser_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_article
    ADD CONSTRAINT wiki_article_author_id_ff87219f_fk_users_customuser_id FOREIGN KEY (author_id) REFERENCES public.users_customuser(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: wiki_article wiki_article_category_id_18cb89c0_fk_wiki_category_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_article
    ADD CONSTRAINT wiki_article_category_id_18cb89c0_fk_wiki_category_id FOREIGN KEY (category_id) REFERENCES public.wiki_category(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: wiki_article_tags wiki_article_tags_article_id_b7b17f39_fk_wiki_article_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_article_tags
    ADD CONSTRAINT wiki_article_tags_article_id_b7b17f39_fk_wiki_article_id FOREIGN KEY (article_id) REFERENCES public.wiki_article(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: wiki_article_tags wiki_article_tags_tag_id_faa96f90_fk_wiki_tag_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_article_tags
    ADD CONSTRAINT wiki_article_tags_tag_id_faa96f90_fk_wiki_tag_id FOREIGN KEY (tag_id) REFERENCES public.wiki_tag(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: wiki_bookmark wiki_bookmark_article_id_9f9d9e8e_fk_wiki_article_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_bookmark
    ADD CONSTRAINT wiki_bookmark_article_id_9f9d9e8e_fk_wiki_article_id FOREIGN KEY (article_id) REFERENCES public.wiki_article(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: wiki_bookmark wiki_bookmark_user_id_596bc124_fk_users_customuser_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_bookmark
    ADD CONSTRAINT wiki_bookmark_user_id_596bc124_fk_users_customuser_id FOREIGN KEY (user_id) REFERENCES public.users_customuser(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: wiki_category wiki_category_parent_id_c3e2dc79_fk_wiki_category_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_category
    ADD CONSTRAINT wiki_category_parent_id_c3e2dc79_fk_wiki_category_id FOREIGN KEY (parent_id) REFERENCES public.wiki_category(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: wiki_viewhistory wiki_viewhistory_article_id_52faa055_fk_wiki_article_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_viewhistory
    ADD CONSTRAINT wiki_viewhistory_article_id_52faa055_fk_wiki_article_id FOREIGN KEY (article_id) REFERENCES public.wiki_article(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: wiki_viewhistory wiki_viewhistory_user_id_959d7a84_fk_users_customuser_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wiki_viewhistory
    ADD CONSTRAINT wiki_viewhistory_user_id_959d7a84_fk_users_customuser_id FOREIGN KEY (user_id) REFERENCES public.users_customuser(id) DEFERRABLE INITIALLY DEFERRED;
